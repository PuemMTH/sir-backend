...
const openapiJSON = `{
  ...
  "paths": {
            ...
            "multipart/form-data": {
              "schema": {
                ...
                "properties": {
                  ...
                  "thumbnail": { "type": "string", "format": "binary", "description": "Optional small image preview generated by the client" }
                }
              }
            }
          }
    ...
    "/api/assets/{id}/content": {
      "get": {
        "tags": ["Assets"],
        "summary": "Fetch original asset content",
        "security": [{ "bearerAuth": [] }],
        "parameters": [
          { "name": "id", "in": "path", "required": true, "schema": { "type": "string" } }
        ],
        "responses": {
          "200": { "description": "Original asset bytes" },
          "401": { "description": "Invalid or missing token" },
          "404": { "description": "Not found" }
        }
      }
    ...
    "/api/assets/{id}/preview": {
      "get": {
        "tags": ["Assets"],
        "summary": "Fetch small asset preview image",
        "security": [{ "bearerAuth": [] }],
        "parameters": [
          { "name": "id", "in": "path", "required": true, "schema": { "type": "string" } }
        ],
        "responses": {
          "200": { "description": "Preview image bytes" },
          "401": { "description": "Invalid or missing token" },
          "404": { "description": "Not found" }
        }
      }
